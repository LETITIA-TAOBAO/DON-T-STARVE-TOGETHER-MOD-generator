...
def render_banner():
    ...
    ">
        ...
        <p style="font-family:Griffy;font-size:1.1rem;line-height:1.8;color:#d4c4a0;">
        ...
        <div style="display:flex;gap:30px;flex-wrap:wrap;justify-content:center;">
            ...
            ">
                ...
                <div style="font-family:Griffy;color:#aa8855;font-size:0.8rem;letter-spacing:2px;">
                RAPID GENERATION
                </div>

                <p style="margin-top:10px;font-size:0.95rem;color:#d4c4a0;">
                当疯狂的构想已然成型，不必犹豫。<br>
                在此刻，将你的意志直接铸造成现实。<br>
            ...
            ">
                ...
                <div style="font-family:Griffy;color:#88aa66;font-size:0.8rem;letter-spacing:2px;">
                DEEP EXPLORATION
                </div>
...
def render_chat(messages):
    for msg in messages:
        if isinstance(msg, dict):
            ...
            if role == 'user':
                st.markdown(f"<div class='chat-box'><b>🧑‍💻 求生者 / SURVIVOR:</b><br>{content}</div>", unsafe_allow_html=True)
            else:
                st.markdown(f"<div class='chat-box' style='border-left-color:#aadd88;'><b>👁️ 暗影 / SHADOW:</b><br>{content}</div>", unsafe_allow_html=True)
        else:
...
def render_loading():
    ...
    <div style="text-align:center;padding:40px;">
        ...
        <div style="font-family:Griffy;color:#aa8855;margin-top:5px;">
